...
export function ProductCard({ name, price, image, category, description, onRequestClick }: ProductCardProps) {
  return (
    <div className="bg-white rounded-xl overflow-hidden border border-gray-200 transition-all hover:shadow-xl hover:scale-[1.02] duration-300">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-[#D32F2F] text-white text-sm rounded-lg hover:bg-[#B71C1C] transition-all hover:shadow-lg"
          >
            Заказать
          </button>
        </div>
